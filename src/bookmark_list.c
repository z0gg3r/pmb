...
int
bookmark_list_enqueue(bookmark_list* l
		      ,char* id
		      ,char* name
		      ,char* url
		      ,char* comment
...
int
bookmark_list_enqueue_bookmark(bookmark_list* l, bookmark* b) 
{
  ...
  int res = bookmark_list_enqueue(l, id, name, url, comment, tag, favicon);
